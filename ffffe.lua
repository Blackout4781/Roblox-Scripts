...
Default = {
    ...
    Topbar = Color3.fromRGB(132, 21, 160),
    Shadow = Color3.fromRGB(166, 10, 238),
    ...
    PlaceholderColor = Color3.fromRGB(178, 178, 178)
        ...
        local Rayfield = game:GetObjects("rbxassetid://13422781427")[1]
        -- pcall(function()
        ...
        function RayfieldLibrary:CreateWindow(Settings)
            ...
            function Window:CreateTab(Name, Image, AllowColorChange)
                ...
                function Tab:CreateDropdown(DropdownSettings)
					...
					local SearchBar = Dropdown.List["Search"]
                    local Required = 1
                            ...
                            for _, DropdownOpt in ipairs(Dropdown.List:GetChildren()) do
                                if DropdownOpt.ClassName == "Frame" and DropdownOpt.Name ~= "Placeholder" and DropdownOpt~= SearchBar then
                                    ...
                                    if DropdownOpt:FindFirstChild("Title") then
                                        ...
                                        TweenService:Create(DropdownOpt.Input, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
                                    end
                                end
                            end
                            ...
                            for _, DropdownOpt in ipairs(Dropdown.List:GetChildren()) do
                                if DropdownOpt.ClassName == "Frame" and DropdownOpt.Name ~= "Placeholder" and DropdownOpt~= SearchBar then
                                    ...
                                    if DropdownOpt:FindFirstChild("Title") then
                                        ...
                                        TweenService:Create(DropdownOpt.Input, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()
                                    end
                                end
                            end
                        end
                    ...
                    Dropdown.List.Search.Input.Changed:Connect(function()
                        if Dropdown.List.Search.Input.Text == "" then
                            for i,v in pairs(Dropdown.List:GetChildren()) do
                                if v:IsA("Frame") and v.Name ~= "Search" and v.Name ~= "Placeholder" then
                                    v.Visible = true
                                end
                            end
                        elseif Dropdown.List.Search.Input.Text ~= "" then
                            for i,v in pairs(Dropdown.List:GetChildren()) do
                                if v:IsA("Frame") and v.Name ~= "Search" and v.Name ~= "Placeholder" then
                                    if not string.find(v.Title.Text:lower(), Dropdown.List.Search.Input.Text:lower()) then
                                        v.Visible = false
                                    end
                                end
                            end
